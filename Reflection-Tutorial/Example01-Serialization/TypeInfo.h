...
{
	using StrippedType = std::remove_cvref_t<remove_all_pointers_t<std::remove_reference_t<std::remove_all_extents_t<T>>>>;
	RegisterType<StrippedType> RegisterType{};

	return TypeId(Reflection::TypeId<StrippedType>());
}
