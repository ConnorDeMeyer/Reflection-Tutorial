...
{
	{
		...
		SerializeType(std::cout, object);

		std::stringstream copyStream{};

		SerializeType(copyStream, object);
		GameObject objectCopy{};
		DeserializeType(copyStream, objectCopy);

		std::cout << "\n\n";

		SerializeType(std::cout, objectCopy);
		...
		SerializeType(std::cout, scene);

		std::cout << "\n\n";

		copyStream.str("");
		SerializeTypeBinary(copyStream, scene);
		Scene sceneCopy{};
		DeserializeTypeBinary(copyStream, sceneCopy);

		SerializeType(std::cout, sceneCopy);
